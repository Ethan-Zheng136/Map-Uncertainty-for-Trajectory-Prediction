...
class MapTRHead(DETRHead):
    ...
    def forward(self, mlvl_feats, lidar_feat, img_metas, prev_bev=None,  only_bev=False):
        ...
        for lvl in range(hs.shape[0]):
            ...
            outputs_pts_corr = corr.view(corr.shape[0], self.num_vec, self.num_pts_per_gt_vec, 1)
            ...
            outputs_pts_corrs.append(outputs_pts_corr)
        ...
        outputs_pts_corrs = torch.stack(outputs_pts_corrs)
        ...
        outs = {
            ...
            'all_pts_corrs': outputs_pts_corrs,
            'enc_cls_scores': None,
            'enc_bbox_preds': None,
            'enc_pts_preds': None
        }
    ...
    def loss_single(self,
        ...
        pts_corrs = pts_corrs.reshape(-1, pts_corrs.size(-2), pts_corrs.size(-1))    #200, 20, 1
