...
class MapTRv2Head(DETRHead):
    ...
    def forward(self, mlvl_feats, lidar_feat, img_metas, prev_bev=None,  only_bev=False):
        ...
        for lvl in range(hs.shape[0]):
            ...
            outputs_pts_corrs_one2one.append(outputs_pts_corr[:, :self.num_vec_one2one])
            ...
            outputs_pts_corrs_one2many.append(outputs_pts_corr[:, self.num_vec_one2one:])
        ...
        outputs_pts_corrs_one2one = torch.stack(outputs_pts_corrs_one2one)
        ...
        outputs_pts_corrs_one2many = torch.stack(outputs_pts_corrs_one2many)
        ...
        outs = {
            ...
            'all_pts_corrs': outputs_pts_corrs_one2one,
            'enc_cls_scores': None,
            'enc_bbox_preds': None,
            'enc_pts_preds': None,
            'depth': depth,
            ...
            "one2many_outs": dict(
                ...
                all_pts_corrs=outputs_pts_corrs_one2many,
                enc_cls_scores=None,
                enc_bbox_preds=None,
                enc_pts_preds=None,
                seg=None,
    ...
    def loss_single(self,
        ...
        pts_corrs_list = [pts_corrs[i] for i in range(num_imgs)]
        ...
        pts_corrs = pts_corrs.reshape(-1, pts_corrs.size(-2), 1)
        out = torch.cat([pts_preds, pts_betas, pts_corrs], dim=2)
    ...
    def loss(self,
        ...
        all_pts_corrs = preds_dicts['all_pts_corrs']
        ...
        losses_cls, losses_bbox, losses_iou, losses_pts, losses_dir = multi_apply(
            self.loss_single, all_cls_scores, all_bbox_preds,all_pts_preds, all_pts_betas, all_pts_corrs,
    ...
    def get_bboxes(self, preds_dicts, img_metas, rescale=False):
        ...
        for i in range(num_samples):
            ...
            ret_list.append([bboxes, scores, labels, pts, betas, corrs, bev, raw_scores])
