...
if __name__ == '__main__':
    ...
    parser.add_argument('--log_root', type=str, default='lightning_logs', help='Directory for logging')
    parser.add_argument('--temperature', type=float, help='Temperature value for model')
    ...
    trainer = pl.Trainer.from_argparse_args(args, callbacks=[model_checkpoint], default_root_dir=args.log_root)
